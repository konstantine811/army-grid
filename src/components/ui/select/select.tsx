...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <span className="sci-select-caret" style={{ color: 'var(--text-muted)', fontSize: '0.6rem', marginLeft: '0.5rem' }}>▼</span>
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    ...
    className={cn(
      ...
      {...props}
    >
      <SelectPrimitive.Viewport className="sci-select-viewport" style={{ padding: '4px 0' }}>
        {children}
